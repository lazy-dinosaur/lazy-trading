      ...
      <div className="w-full min-h-[180px] h-auto border rounded-md shadow-sm p-2">
        <Tabs defaultValue="long" className="w-full">
          <TabsList className="w-full grid grid-cols-2 mb-2">
            <TabsTrigger value="long" className="data-[state=active]:bg-green-500 data-[state=active]:text-white">롱 포지션</TabsTrigger>
            <TabsTrigger value="short" className="data-[state=active]:bg-red-500 data-[state=active]:text-white">숏 포지션</TabsTrigger>
          </TabsList>
    ...
    <div className="w-full min-h-[180px] h-auto lg:h-full border rounded-md shadow-sm p-3 bg-card/20">
      <Tabs defaultValue="long" className="w-full h-full">
        <TabsList className="w-full grid grid-cols-2 mb-3">
          <TabsTrigger 
            value="long" 
            className="py-2 text-base font-medium data-[state=active]:bg-green-500 data-[state=active]:text-white"
          >
            롱 포지션
          </TabsTrigger>
          <TabsTrigger 
            value="short"
            className="py-2 text-base font-medium data-[state=active]:bg-red-500 data-[state=active]:text-white"
          >
            숏 포지션
          </TabsTrigger>
        </TabsList>
